## <img src="resources/logo.png" width="50"/> My Org Butler [`v2026.7.1`](https://github.com/aquivalabs/my-org-butler/releases/tag/v2026.7.1)
...
2. **Install My Org Butler** - Grab the latest package version ID from [sfdx-project.json](sfdx-project.json) and install via [Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tVI000000d7cjYAA) or [Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tVI000000d7cjYAA)
